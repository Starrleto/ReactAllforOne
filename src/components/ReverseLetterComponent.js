...
import { reverseWord } from '../services/DataServices';


export default function ReverseLetterComponent() {
...
const getResult = async() => {
    ...
    const promise = await reverseWord(name);
    setResult(promise);
}
  ...
  return (
    ...
    <Navbar expand="lg" className="flex funny-navbar">
        ...
        <h1 className="main-title-2">Reverse Words</h1>
        <p className="subs separate-bottom">Enter some words and get it back reversed.</p>
            <Form>
