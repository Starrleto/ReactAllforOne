...
import { reverseNum } from '../services/DataServices';
...
const getResult = async() => {
    ...
    const promise = await reverseNum(name);
    setResult(promise);
}
  ...
  return (
    ...
    <Navbar expand="lg" className="flex funny-navbar">
        ...
        <h1 className="main-title-2">Reverse Numbers</h1>
        <p className="subs separate-bottom">Enter a number and get it back reverse.</p>
            <Form>
