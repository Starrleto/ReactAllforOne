...
import { restaraunt } from '../services/DataServices';


export default function RestarauntPickerComponent() {
...
const getResult = async() => {
    ...
    const promise = await restaraunt(name);
    setResult(promise);
}
  ...
  return (
    ...
    <Navbar expand="lg" className="flex funny-navbar">
        ...
        <h1 className="main-title-2">Restaraunt Picker</h1>
        <p className="subs separate-bottom">Enter Asian, Mexican, or American to get a random restaraunt of that type.</p>
            <Form>
            <Form.Group as={Row} className="mb-3" controlId="formPlaintextPassword">
            <Form.Label column sm="8" lg="5" md="5">
            Enter one: 
            </Form.Label>
            <Col sm="4" lg="7" md="7">
