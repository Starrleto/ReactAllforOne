...
import { magicEight } from '../services/DataServices';
...
const getResult = async() => {
    ...
    const promise = await magicEight(name);
    setResult(promise);
}
  ...
  return (
    ...
    <Navbar expand="lg" className="flex funny-navbar">
        ...
        <h1 className="main-title-2">Magic Eight Ball</h1>
        <p className="subs separate-bottom">Enter a question, get an answer.</p>
            <Form>
