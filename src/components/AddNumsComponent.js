...
import { addNums } from '../services/DataServices';


export default function AddNumsComponent() {
...
const getResult = async() => {
    ...
    const promise = await addNums(numOne, numTwo);
    setResult(promise);
}
  ...
  return (
    ...
    <Navbar expand="lg" className="flex funny-navbar">
        ...
        <h1 className="main-title-2">Add Numbers</h1>
        <p className="subs separate-bottom">Enter two numbers to add them.</p>
            <Form>
