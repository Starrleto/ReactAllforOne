...
import { oddEven } from '../services/DataServices';
...
const getResult = async() => {
    ...
    const promise = await oddEven(name);
    setResult(promise);
}
  ...
  return (
    ...
    <Navbar expand="lg" className="flex funny-navbar">
        ...
        <h1 className="main-title-2">Odd or Even</h1>
        <p className="subs separate-bottom">Enter a number to see if it's even or odd.</p>
            <Form>
